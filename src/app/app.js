...
var experimental_1 = require('./experimental/experimental');
/*
 * App Component
 * Top Level Component
 */
var App = (function () {
    ...
    App = __decorate([
        core_1.Component({
            ...
            template: "\n    <header>\n      <nav>\n        <h1>Hello {{ name }}</h1>\n        <ul>\n          <li router-active>\n            <a [routerLink]=\" ['Index'] \">Index</a>\n          </li>\n          <li router-active>\n            <a [routerLink]=\" ['Home'] \">Home</a>\n          </li>\n          <li router-active>\n            <a [routerLink]=\" ['About'] \">About</a>\n          </li>\n          <li router-active>\n            <a [routerLink]=\" ['Experimental'] \">Experimental</a>\n          </li>          \n        </ul>\n      </nav>\n    </header>\n\n    <main>\n      <router-outlet></router-outlet>\n    </main>\n\n    <footer>\n      WebPack Angular 2 Starter by <a [href]=\"url\">@AngularClass</a>\n      <div>\n        <img [src]=\"angularclassLogo\" width=\"10%\">\n      </div>\n    </footer>\n  "
        }),
        router_1.RouteConfig([
            ...
            { path: '/experimental', component: experimental_1.Experimental, name: 'Experimental' },
